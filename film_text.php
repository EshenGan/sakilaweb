...
<html lang="en">
	...
	<head>
		<title> SAKILA | FILM DESCRIPTION</title>
		<meta charset="UTF-8" />
	...
	<!--FILM_TEXT table-->
		<table class="container-fluid" border="1" style="width:80%;border-collapse:collapse;align:center;margin-left:10%;margin-right:10%">
			<tr>
				<th style="width:99%;font-size:3vw" colspan="11"><h1>FILM DESCRIPTION</h1></th>
			</tr>
			<tr>
				<th style="width:20%;font-size:1vw" >FILM ID</th>
				<th style="width:20%;font-size:1vw" >TITLE</th>
				<th style="width:80%;font-size:1vw" >DESCRIPTION</th>
				<th style="width:20%;font-size:1vw" >UPDATE</th>
				<th style="width:20%;font-size:1vw" >DELETE</th>
			</tr>
			...
			?>
				<tr id="data">
				    <td style="width:5%;font-size:1vw" > <?php echo $rows['FILM_ID']; ?> </td>
				    <td style="width:9%;font-size:1vw" > <?php echo $rows['TITLE']; ?> </td>
				    <td style="width:9%;font-size:1vw;overflow-y:hidden" > <?php echo $rows['DESCRIPTION']; ?> </td>
				    <td style="width:100%;font-size:1vw;height:100%" class="w3-dropdown-click">
				        <a href="updatefilmtrow.php?filmtid=<?php echo $rows['FILM_ID']; ?>" style=text-decoration:none> 
				    	<button type="button" style="width:100%;height:100%" height="100%" onclick="myFunction()" class="w3-button w3-black">
				    	     <span style="font-size:1vw">UPDATE</span>
				    	</button> 
				    	</a>
    				</td>
				    <td style="width:100%;font-size:1vw;height:100%"> 
			        <button type="button" style="width:100%;height:100%" onclick="myFunction()" class="w3-button w3-red">
				        <?php echo "<a style= text-decoration:none href=delete1.php?id13=".$rows['FILM_ID'].">"?>
