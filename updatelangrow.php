<?php
    ...
    $langid = $_GET['langid'];
    $result = mysqli_query($conn,"SELECT * FROM LANGUAGE WHERE LANGUAGE_ID='$langid'");
    ...
    if(isset($_POST['updatelang']))
    {
        ...
        $update = mysqli_query($conn,"UPDATE LANGUAGE SET NAME='$name', LAST_UPDATE='$lastupdate' WHERE LANGUAGE_ID='$langid';");
...
?>
	...
	<head>
		<title> SAKILA | LANGUAGE UPDATE</title>
		<meta charset="UTF-8" />
	...
	<body>
		...
		<table id="Demo" style="background-color: powderblue;" align="center">
			<tr><form method="POST">
			    ...
			    <td><input type="submit" name="updatelang" value="UPDATE">
			</form></td>
      	</table>
    </body> 