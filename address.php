...
<html lang="en">
	...
	<!--ADDRESS table-->
		<table class="container-fluid" border="1"  style="width:100%;border-collapse:collapse;align:center">
			<tr>
				<th colspan="10" style="width:100%;font-size:3vw"><h1>ADDRESS</h1></th>
			</tr>
			<tr  style="width:100%">
				<th style="width:10%;font-size:1vw">ADDRESS_ID</th>
				<th style="width:10%;font-size:1vw">ADDRESS</th>
				<th style="width:10%;font-size:1vw">ADDRESS2</th>
				<th style="width:10%;font-size:1vw">DISTRICT</th>
				<th style="width:10%;font-size:1vw">CITY_ID</th>
				<th style="width:10%;font-size:1vw">POSTAL_CODE</th>
				<th style="width:10%;font-size:1vw">PHONE</th>
			...
			<tr>
				...
				<th style="width:10%;font-size:1vw;background-color:#24CCCA" >
				    <form role="form" action="updatecol.php" method="post">
				        <input type="submit" value="UPDATE" name="addluid" style="width:100%">
				    </form></th>	
				<th style="width:10%;font-size:1vw;background-color:#24CCCA" >&nbsp;</th>
				<th style="width:10%;font-size:1vw;background-color:#24CCCA" >&nbsp;</th>				
			</tr>
			...
			?>
				<tr id="data">
				    ...
				    <td style="width:10%;font-size:1vw"> <?php echo $rows['ADDRESS']; ?> </td>
				    <td style="width:10%;font-size:1vw"> <?php echo $rows['ADDRESS2']; ?> </td>
					<td style="width:10%;font-size:1vw"> <?php echo $rows['DISTRICT']; ?> </td>
					<td style="width:10%;font-size:1vw"> <?php echo $rows['CITY_ID']; ?> </td>
					<td style="width:10%;font-size:1vw"> <?php echo $rows['POSTAL_CODE']; ?> </td>
					<td style="width:10%;font-size:1vw"> <?php echo $rows['PHONE']; ?> </td>
				    <td style="width:10%;font-size:1vw"> <?php echo $rows['LAST_UPDATE']; ?> </td>
				    <td style="width:100%;font-size:1vw" class="w3-dropdown-click">
				        <a href="updateaddressrow.php?addid=<?php echo $rows['ADDRESS_ID']; ?>" style=text-decoration:none> 
				    ...
				    <button type="button" style="width:100%" onclick="myFunction()" class="w3-button w3-red">
				        <?php echo "<a style= text-decoration:none href=delete1.php?id2=".$rows['ADDRESS_ID'].">"?>
