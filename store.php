...
<html lang="en">
	...
	<!--store table-->
		<table class="container-fluid" border="1" align="center" style="border-collapse:collapse;width:60%;margin-left:20%;margin-right:20%">
			<tr>
				<th colspan="6"><h1>STORE</h1></th>
			</tr>
			<tr>
				<th style="width:10%;font-size:1vw">STORE_ID</th>
				<th style="width:10%;font-size:1vw">MANAGER_STAFFF_ID</th>
			...
			<tr>
				...
				<th style="width:10%;font-size:1vw;background-color:#24CCCA" >
				    <form role="form" action="updatecol.php" method="post">
				        <input type="submit" value="UPDATE" name="strluid" style="width:100%;font-size:1vw;color:black;text-decoration:none">
				    </form>
			    </th>
				<th style="width:10%;font-size:1vw;background-color:#24CCCA" >&nbsp;</th>
				<th style="width:10%;font-size:1vw;background-color:#24CCCA" >&nbsp;</th>
			...
			?>
				<tr id="data">
				    ...
				    <td style="width:10%;font-size:1vw"> <?php echo $rows['MANAGER_STAFF_ID']; ?> </td>
				    ...
				    <td style="width:10%;font-size:1vw"> <?php echo $rows['LAST_UPDATE']; ?> </td>
				     <td style="width:100%;font-size:1vw" class="w3-dropdown-click">
				        <a href="updatestrrow.php?strid=<?php echo $rows['STORE_ID']; ?>" style=text-decoration:none> 
				    ...
				    <button type="button" style="width:100%" onclick="myFunction()" class="w3-button w3-red">
				        <?php echo "<a style= text-decoration:none href=delete1.php?id19=".$rows['STORE_ID'].">"?>
