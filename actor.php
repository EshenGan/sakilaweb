...
<html lang="en">
	...
	<!--actor table-->
		<table  class="container-fluid" border="1" style="align:center;width:60%;border-collapse:collapse;margin-left:20%;margin-right:20%">
			<tr>
				<th style="align:center;width:60%;font-size:3vw" colspan="6"><h1>ACTOR</h1></th>
			</tr>
			<tr>
				<th style="width:10%;font-size:1vw" >ACTOR_ID</th>
			...
			<tr>
				...
				<th style="width:10%;font-size:1vw;background-color:#24CCCA" >
				    <form role="form" action="updatecol.php" method="post">
				        <input type="submit" value="UPDATE" name="actorluid" style="width:100%;font-size:1vw;color:black;text-decoration:none">
				    </form>
				    </th>
				<th style="width:10%;font-size:1vw;background-color:#24CCCA" >&nbsp;</th>
				<th style="width:10%;font-size:1vw;background-color:#24CCCA" >&nbsp;</th>
			...
			?>
				<tr id="data">
				    <td style="width:10%;font-size:1vw"> <?php echo $rows['ACTOR_ID']; ?> </td>
				    ...
				    <td style="width:10%;font-size:1vw">
				        <?php echo "<a style=text-decoration:none href=updateactorrow.php?actorid=".$rows['ACTOR_ID'].">"?> 
				    	<button type="button" style="width:100%" onclick="myFunction()" class="w3-button w3-black" >
				    	    <span style="font-size:1vw;color:white;text-decoration:none" >UPDATE</span>
				    	</button>
				    	<?php echo "</a>" ?>
				    	</a>
    				</td>
                    ...
                    <td  style="width:10%;font-size:1vw">
				        <?php echo "<a style= text-decoration:none href=delete1.php?id1=".$rows['ACTOR_ID'].">"?>
