...
<html lang="en">
	...
	<head>
		<title> SAKILA | FILM CATEGORY</title>
		<meta charset="UTF-8" />
	...
	<!--FILM_CATEGORY table-->
		<table class="container-fluid" border="1" style="width:60%;border-collapse:collapse;align:center;margin-left:20%;margin-right:20%">
			<tr>
				<th style="width:100%;font-size:3vw" colspan="5"><h1>FILM CATEGORY</h1></th>
			</tr>
			<tr>
				<th style="width:20%;font-size:1vw" >FILM ID</th>
				<th style="width:20%;font-size:1vw" >CATEGORY ID</th>
				<th style="width:20%;font-size:1vw" >LAST UPDATE</th>
				<th style="width:20%;font-size:1vw" >UPDATE</th>
				<th style="width:20%;font-size:1vw" >DELETE</th>
			</tr>
		<tr>
				<th style="width:20%;font-size:1vw;background-color:#24CCCA" >&nbsp;</th>
				<th style="width:20%;font-size:1vw;background-color:#24CCCA" >&nbsp;</th>
				<th style="width:20%;font-size:1vw;background-color:#24CCCA" >
				    <form role="form" action="updatecol.php" method="post">
				        <input type="submit" value="UPDATE" name="filmcatluid" style="width:100%;font-size:1vw;color:black;text-decoration:none">
				    </form>
				    </th>
				<th style="width:20%;font-size:1vw;background-color:#24CCCA" >&nbsp;</th>
				<th style="width:20%;font-size:1vw;background-color:#24CCCA" >&nbsp;</th>
			...
			?>
				<tr id="data">
				    <td style="width:20%;font-size:1vw" > <?php echo $rows['FILM_ID']; ?> </td>
				    <td style="width:20%;font-size:1vw" > <?php echo $rows['CATEGORY_ID']; ?> </td>
				    <td style="width:20%;font-size:1vw" > <?php echo $rows['LAST_UPDATE']; ?> </td>
				    <td style="width:100%;font-size:1vw" class="w3-dropdown-click">
				        <a href="updatefilmcatrow.php?filmcatid=<?php echo $rows['FILM_ID']; ?>" style=text-decoration:none> 
				    	<button type="button" style="width:100%" onclick="myFunction()" class="w3-button w3-black">
				    	     <span style="font-size:1vw">UPDATE</span>
				    	</button> 
				    	</a>
    				</td>
				    <td style="width:20%;font-size:1vw"> 
				    	<button type="button" style="width:100%" onclick="myFunction()" class="w3-button w3-red">
				        <?php echo "<a style= text-decoration:none href=delete1.php?id10=".$rows['FILM_ID']."&id11=".$rows['CATEGORY_ID'].">"?>
