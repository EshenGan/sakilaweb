...
<html lang="en">
	...
	<!--FILM_ACTOR table-->
		<table class="container-fluid" border="1" style="width:60%;border-collapse:collapse;align:center;margin-left:20%;margin-right:20%">
			<tr>
				<th style="width:100%;font-size:3vw" colspan="5"><h1>FILM ACTOR</h1></th>
			</tr>
			<tr>
				<th style="width:20%;font-size:1vw" >ACTOR ID</th>
				<th style="width:20%;font-size:1vw" >FILM ID</th>
				<th style="width:20%;font-size:1vw" >LAST_UPDATE</th>
			...
			<tr>
				...
				<th style="width:10%;background-color:#24CCCA" >
				    <form role="form" action="updatecol.php" method="post">
				        <input type="submit" value="UPDATE" name="filmactorluid" style="width:100%;font-size:1vw">
				    </form></th>
				<th style="width:10%;background-color:#24CCCA" >&nbsp;</th>
				<th style="width:10%;background-color:#24CCCA" >&nbsp;</th>
		    </tr>
			...
			?>
				<tr id="data">
				    <td style="width:20%;font-size:1vw" > <?php echo $rows['ACTOR_ID']; ?> </td>
				    ...
				    <td style="width:100%;font-size:1vw" class="w3-dropdown-click">
				        <a href="updatefilmactorrow.php?filmactorid=<?php echo $rows['ACTOR_ID']; ?>" style=text-decoration:none> 
				    ...
				    <button type="button" style="width:100%" onclick="myFunction()" class="w3-button w3-red">
				        <?php echo "<a style= text-decoration:none href=delete1.php?id8=".$rows['ACTOR_ID']."&id9=".$rows['FILM_ID'].">"?>
