...
<html lang="en">
				...
				<div class="navbar" style="margin-bottom:2vw">
				 ...
				 <div class="dropdown">
					...
					<div class="dropdown-content">
					  ...
					  <a href="film_category.php">FILM CAT</a>
	...
	<!--CATEGORY table-->
		<table class="container-fluid" border="1" style="align:center;width:60%;border-collapse:collapse;margin-left:20%;margin-right:20%">
			<tr>
				<th style="width:100%;font-size:3vw;align:center" colspan="5"><h1>CATEGORY</h1></th>
			</tr>
			<tr>
				<th style="width:20%;font-size:1vw" >CATEGORY_ID</th>
				<th style="width:20%;font-size:1vw" >NAME</th>
			...
			<tr>
			    ...
			    <th style="width:10%;background-color:#24CCCA" >
				    <form role="form" action="updatecol.php" method="post">
				        <input type="submit" value="UPDATE" name="catluid" style="width:100%">
				    </form></th>
				<th style="width:10%;font-size:1vw;background-color:#24CCCA" >&nbsp;</th>
				<th style="width:10%;font-size:1vw;background-color:#24CCCA" >&nbsp;</th>
			</tr>
			...
			?>
				<tr id="data">
				    ...
				    <td style="width:20%;font-size:1vw" > <?php echo $rows['NAME']; ?> </td>
				    <td style="width:20%;font-size:1vw" > <?php echo $rows['LAST_UPDATE']; ?> </td>
				    <td style="width:100%;font-size:1vw" class="w3-dropdown-click">
				        <a href="updatecategoryrow.php?categoryid=<?php echo $rows['CATEGORY_ID']; ?>" style=text-decoration:none> 
				    ...
				    <button type="button" style="width:100%" onclick="myFunction()" class="w3-button w3-red">
				        <?php echo "<a style= text-decoration:none href=delete1.php?id3=".$rows['CATEGORY_ID'].">"?>
