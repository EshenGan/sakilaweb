...
<html lang="en">
	...
	<div style="overflow-x:auto;">
		<table class="container-fluid" border="1" style="width:90%;border-collapse:collapse;align:center;margin-left:5%;margin-right:5%">
			<tr>
				<th colspan="9"><h1>FILM</h1></th>
			</tr>
			<tr>
				<th style="width:10%;font-size:1em">FILM_ID</th>
				<th style="width:10%;font-size:1em">RELEASE_YEAR</th>
				<th style="width:10%;font-size:1em">LANGUAGE_ID</th>
				<th style="width:10%;font-size:1em">ORIGINAL_LANGUAGE_ID</th>
				<th style="width:10%;font-size:1em">RATING</th>
				<th style="width:10%;font-size:1em">SPECIAL_FEATURES</th>
				<th style="width:10%;font-size:1em">LAST_UPDATE</th>
				<th style="width:10%;font-size:1em">UPDATE</th>
				<th style="width:10%;font-size:1em">DELETE</th>
			</tr>
			...
			<tr>
				...
				<th style="width:10%;font-size:1em;background-color:#24CCCA" >&nbsp;</th>
				<th style="width:10%;font-size:1em;background-color:#24CCCA" >&nbsp;</th>
				<th style="width:10%;font-size:1em;background-color:#24CCCA" >
				    <form role="form" action="updatecol.php" method="post">
				        <input type="submit" value="UPDATE" name="filmluid" style="width:100%;">
				    </form>
				</th>
	            <th style="width:10%;font-size:1em;background-color:#24CCCA" >&nbsp;</th>
	            <th style="width:10%;font-size:1em;background-color:#24CCCA" >&nbsp;</th>
			...
			?>
				<tr id="data">
				    ...
				    <td style="width:10%;font-size:1vw"> <?php echo $rows['RELEASE_YEAR']; ?> </td>
				    <td style="width:10%;font-size:1vw"> <?php echo $rows['LANGUAGE_ID']; ?> </td>
					<td style="width:10%;font-size:1vw"> <?php echo $rows['ORIGINAL_LANGUAGE_ID']; ?> </td>
					<td style="width:10%;font-size:1vw"> <?php echo $rows['RATING']; ?> </td>
					<td style="width:10%;font-size:1vw"> <?php echo $rows['SPECIAL_FEATURES']; ?> </td>
				    <td style="width:10%;font-size:1vw"> <?php echo $rows['LAST_UPDATE']; ?> </td>
				    <td style="width:100%;font-size:1vw" class="w3-dropdown-click">
				        <a href="updatefilmrow.php?filmid=<?php echo $rows['FILM_ID']; ?>" style=text-decoration:none> 
				    ...
				    <button type="button" style="width:100%" onclick="myFunction()" class="w3-button w3-red">
				        <?php echo "<a style= text-decoration:none href=delete1.php?id7=".$rows['FILM_ID'].">"?>
