...
<html lang="en">
	...
	<div style="overflow-x:auto;">
		<table class="container-fluid" border="1" align="center" style="width:60%;border-collapse:collapse;margin-left=20%;margin-right=20%">
			<tr>
				<th  style="width:100%:font-size:3vw" colspan="5"><h1>COUNTRY</h1></th>
			</tr>
			<tr>
				<th  style="width:20%;font-size:1em">COUNTRY_ID</th>
				<th  style="width:20%;font-size:1em">COUNTRY</th>
				<th  style="width:20%;font-size:1em">LAST_UPDATE</th>
				<th  style="width:20%;font-size:1em">UPDATE</th>
				<th  style="width:20%;font-size:1em">DELETE</th>
			</tr>
			<tr>
				<th  style="width:20%;font-size:1em;background-color:#24CCCA"></th>
				<th  style="width:20%;font-size:1em;background-color:#24CCCA"></th>
				<th style="width:10%;font-size:1em;background-color:#24CCCA" >
				    <form role="form" action="updatecol.php" method="post">
				        <input type="submit" value="UPDATE" name="countryluid" style="width:100%">
				    </form>
				    </th>
				<th  style="width:20%;font-size:1em;background-color:#24CCCA"></th>
				<th  style="width:20%;font-size:1em;background-color:#24CCCA"></th>
			...
			?>
				<tr id="data">
				    <td style="width:20%:font-size:1vw" > <?php echo $rows['COUNTRY_ID']; ?> </td>
				    <td style="width:20%:font-size:1vw"> <?php echo $rows['COUNTRY']; ?> </td>
				    <td style="width:20%:font-size:1vw"> <?php echo $rows['LAST_UPDATE']; ?> </td>
				    <td style="width:100%;font-size:1vw" class="w3-dropdown-click">
				        <a href="updatecountryrow.php?countryid=<?php echo $rows['COUNTRY_ID']; ?>" style=text-decoration:none> 
				    ...
				    <button type="button" style="width:100%" onclick="myFunction()" class="w3-button w3-red">
				        <?php echo "<a style= text-decoration:none href=delete1.php?id5=".$rows['COUNTRY_ID'].">"?>
