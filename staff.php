...
<html lang="en">
	...
	<div style="overflow-x:auto">
		<table class="container-fluid" border="1" align="center" style="border-collapse:collapse">
			<tr>
				<th colspan="13"><h1>STAFF</h1></th>
			</tr>
			<tr>
				<th style="width:10%;font-size:1vw">STAFF_ID</th>
				<th style="width:10%;font-size:1vw">FIRST_NAME</th>
				<th style="width:10%;font-size:1vw">LAST_NAME</th>
				<th style="width:10%;font-size:1vw">ADDRESS_ID</th>
				<th style="width:10%;font-size:1vw">PICTURE</th>
				<th style="width:10%;font-size:1vw">EMAIL</th>
				<th style="width:10%;font-size:1vw">STORE_ID</th>
				<th style="width:10%;font-size:1vw">ACTIVE</th>
				<th style="width:10%;font-size:1vw">USERNAME</th>
				<th style="width:10%;font-size:1vw">PASSWORD</th>
			...
			<tr>
				...
				<th style="width:10%;font-size:1vw;background-color:#24CCCA" >
				    <form role="form" action="updatecol.php" method="post">
				        <input type="submit" value="UPDATE" name="staffstoreid" style="width:100%;font-size:1vw;color:black;text-decoration:none">
				    </form>
				</th>
				<th style="width:10%;font-size:1vw;background-color:#24CCCA" >
				    <form role="form" action="updatecol.php" method="post">
				        <input type="submit" value="UPDATE" name="staffactiveid" style="width:100%;font-size:1vw;color:black;text-decoration:none">
				    </form>
			    </th>
			    <th style="width:10%;font-size:1vw;background-color:#24CCCA" >&nbsp;</th>
				<th style="width:10%;font-size:1vw;background-color:#24CCCA" >&nbsp;</th>
				<th style="width:10%;font-size:1vw;background-color:#24CCCA" >
				    <form role="form" action="updatecol.php" method="post">
				        <input type="submit" value="UPDATE" name="staffluid" style="width:100%;font-size:1vw;color:black;text-decoration:none">
				    </form>
			    </th>
				<th style="width:10%;font-size:1vw;background-color:#24CCCA" >&nbsp;</th>
				<th style="width:10%;font-size:1vw;background-color:#24CCCA" >&nbsp;</th>
			...
			?>
				<tr id="data">
				    <td style="width:10%;font-size:1vw"> <?php echo $rows['STAFF_ID']; ?> </td>
				    <td style="width:10%;font-size:1vw"> <?php echo $rows['FIRST_NAME']; ?> </td>
				    <td style="width:10%;font-size:1vw"> <?php echo $rows['LAST_NAME']; ?> </td>
					<td style="width:10%;font-size:1vw"> <?php echo $rows['ADDRESS_ID']; ?> </td>
					<td style="width:10%;font-size:1vw"> <?php echo $rows['PICTURE']; ?> </td>
					<td style="width:10%;font-size:1vw"> <?php echo $rows['EMAIL']; ?> </td>
					<td style="width:10%;font-size:1vw"> <?php echo $rows['STORE_ID']; ?> </td>
					<td style="width:10%;font-size:1vw"> <?php echo $rows['ACTIVE']; ?> </td>
					<td style="width:10%;font-size:1vw"> <?php echo $rows['USERNAME']; ?> </td>
					<td style="width:10%;font-size:1vw"> <?php echo $rows['PASSWORD']; ?> </td>
				    <td style="width:10%;font-size:1vw"> <?php echo $rows['LAST_UPDATE']; ?> </td>
                    <td style="width:100%;font-size:1vw" class="w3-dropdown-click">
				        <a href="updatestaffrow.php?staffid=<?php echo $rows['STAFF_ID']; ?>" style=text-decoration:none> 
				    ...
				    <button type="button" style="width:100%"  onclick="myFunction()" class="w3-button w3-red">
				        <?php echo "<a style= text-decoration:none href=delete1.php?id18=".$rows['STAFF_ID'].">"?>
