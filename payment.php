...
<html lang="en">
	...
	<div style="overflow-x:auto;">
		<table class="container-fluid" border="1" align="center" style="border-collapse:collapse;width:90%;margin-left:5%;margin-right:5%">
			<tr>
				<th colspan="9"><h1>PAYMENT</h1></th>
			</tr>
			<tr>
				<th style="width:10%;font-size:1vw">PAYMENT_ID</th>
				<th style="width:10%;font-size:1vw">CUSTOMER_ID</th>
				<th style="width:10%;font-size:1vw">STAFF_ID</th>
				<th style="width:10%;font-size:1vw">RENTAL_ID</th>
				<th style="width:10%;font-size:1vw">AMOUNT</th>
				<th style="width:10%;font-size:1vw">PAYMENT_DATE</th>
			...
			<tr>
				...
				<th style="width:10%;background-color:#24CCCA" >
				    <form role="form" action="updatecol.php" method="post">
				        <input type="submit" value="UPDATE" name="paystaffid" style="width:100%">
				    </form>
				</th>
				<th style="width:10%;background-color:#24CCCA" ></th>
				<th style="width:10%;background-color:#24CCCA" ></th>
				...
				<th style="width:10%;background-color:#24CCCA" >
				    <form role="form" action="updatecol.php" method="post">
				        <input type="submit" value="UPDATE" name="payluid" style="width:100%">
				    </form>
				</th>
				<th style="width:10%;background-color:#24CCCA" ></th>
				<th style="width:10%;background-color:#24CCCA" ></th>
			...
			?>
				<tr id="data">
				    <td style="width:10%;font-size:1vw"> <?php echo $rows['PAYMENT_ID']; ?> </td>
				    <td style="width:10%;font-size:1vw"> <?php echo $rows['CUSTOMER_ID']; ?> </td>
				    <td style="width:10%;font-size:1vw"> <?php echo $rows['STAFF_ID']; ?> </td>
					<td style="width:10%;font-size:1vw"> <?php echo $rows['RENTAL_ID']; ?> </td>
					<td style="width:10%;font-size:1vw"> <?php echo $rows['AMOUNT']; ?> </td>
					<td style="width:10%;font-size:1vw"> <?php echo $rows['PAYMENT_DATE']; ?> </td>
				    <td style="width:10%;font-size:1vw"> <?php echo $rows['LAST_UPDATE']; ?> </td>
				     <td style="width:100%;font-size:1vw" class="w3-dropdown-click">
				        <a href="updatepayrow.php?payid=<?php echo $rows['PAYMENT_ID']; ?>" style=text-decoration:none> 
				    ...
				    <button type="button" style="width:100%" onclick="myFunction()" class="w3-button w3-red">
				        <?php echo "<a style= text-decoration:none href=delete1.php?id16=".$rows['PAYMENT_ID'].">"?>
