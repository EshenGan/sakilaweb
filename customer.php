...
<html lang="en">
	...
	<!--navigation_bar-->
				<div class="navbar" style="margin-bottom:2vw" id="forupdate">
				  <div class="dropdown">
	...
	<div style="overflow-x:auto;">
		<table  class="container-fluid" border="1" style="width:90%;border-collapse:collapse;margin-left:0.5%;margin-right:0.5%">
			<tr>
				<th style="width:60%;font-size:3vw" colspan="11"><h1>CUSTOMER</h1></th>
			</tr>
			<tr>
				<th style="width:5%;font-size:1em" >CUSTOMER_ID</th>
				<th style="width:9%;font-size:1em" >STORE_ID</th>
				<th style="width:9%;font-size:1em" >FIRST_NAME</th>
				<th style="width:9%;font-size:1em" >LAST_NAME</th>
				<th style="width:9%;font-size:1em" >EMAIL</th>
				<th style="width:9%;font-size:1em" >ADDRESS_ID</th>
				<th style="width:9%;font-size:1em" >ACTIVE</th>
				<th style="width:9%;font-size:1em" >CREATE_DATE</th>
				<th style="width:9%;font-size:1em" >LAST_UPDATE</th>
				<th style="width:9%;font-size:1em" >UPDATE</th>
				<th style="width:9%;font-size:1em" >DELETE</th>
			</tr>
			<tr>
				<th style="width:10%;font-size:1em;background-color:#24CCCA" >&nbsp;</th>
				<th style="width:10%;background-color:#24CCCA" >
				    <form role="form" action="updatecol.php" method="post">
				        <input type="submit" value="UPDATE" name="storeidcol" style="width:100%">
				    </form></th>
				<th style="width:10%;background-color:#24CCCA" ></th>
				<th style="width:10%;background-color:#24CCCA" ></th>
				<th style="width:10%;background-color:#24CCCA" ></th>
				<th style="width:10%;background-color:#24CCCA" ></th>
				<th style="width:10%;background-color:#24CCCA" >
				    <form role="form" action="updatecol.php" method="post">
				        <input type="submit" value="UPDATE" name="activeid" style="width:100%">
				    </form></th>
				<th style="width:10%;background-color:#24CCCA" >
				    <form role="form" action="updatecol.php" method="post">
				        <input type="submit" value="UPDATE" name="createdateid" style="width:100%">
				    </form></th>
				<th style="width:10%;background-color:#24CCCA" >
				    <form role="form" action="updatecol.php" method="post">
				        <input type="submit" value="UPDATE" name="lastupdateid" style="width:100%">
				    </form></th>
				<th style="width:10%;background-color:#24CCCA" ></th>
				<th style="width:10%;background-color:#24CCCA" ></th>
			</tr>
			...
			?>
				<tr id="data">
				    <td style="width:9%;font-size:1vw" > <?php echo $rows['CUSTOMER_ID']; ?> </td>
				    <td style="width:9%;font-size:1vw" > <?php echo $rows['STORE_ID']; ?> </td>
				    <td style="width:9%;font-size:1vw" > <?php echo $rows['FIRST_NAME']; ?> </td>
					<td style="width:9%;font-size:1vw" > <?php echo $rows['LAST_NAME']; ?> </td>
					<td style="width:9%;font-size:1vw" > <?php echo $rows['EMAIL']; ?> </td>
					<td style="width:9%;font-size:1vw" > <?php echo $rows['ADDRESS_ID']; ?> </td>
					<td style="width:9%;font-size:1vw" > <?php echo $rows['ACTIVE']; ?> </td>
					<td style="width:9%;font-size:1vw" > <?php echo $rows['CREATE_DATE']; ?> </td>
				    <td style="width:9%;font-size:1vw" > <?php echo $rows['LAST_UPDATE']; ?> </td>
				    <td style="width:100%;font-size:1vw" class="w3-dropdown-click">
				        <a href="updatecustomerrow.php?customerid=<?php echo $rows['CUSTOMER_ID']; ?>" style=text-decoration:none> 
				    ...
				    <button type="button" style="width:100%" onclick="myFunction()" class="w3-button w3-red">
				        <?php echo "<a style= text-decoration:none href=delete1.php?id6=".$rows['CUSTOMER_ID'].">"?>
