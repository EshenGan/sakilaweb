...
<html lang="en">
	...
	<!--CITY table-->
		...
		<table class="container-fluid" border="1" align="center" style="width:60%;border-collapse:collapse">
			<tr>
				<th style="width:60%;font-size:3vw" colspan="6"><h1>CITY</h1></th>
			</tr>
			<tr>
				<th style="width:10%;font-size:1em" >CITY_ID</th>
				<th style="width:10%;font-size:1em" >CITY</th>
				<th style="width:10%;font-size:1em" >COUNTRY_ID</th>
				<th style="width:10%;font-size:1em" >LAST_UPDATE</th>
				<th style="width:10%;font-size:1em" >UPDATE</th>
				<th style="width:10%;font-size:1em" >DELTE</th>
			</tr>
			...
			<tr>
				...
				<th style="width:10%;font-size:1em;background-color:#24CCCA" >
				    <form role="form" action="updatecol.php" method="post">
				        <input type="submit" value="UPDATE" name="cityluid" style="width:100%">
				    </form>
				    </th>
				<th style="width:10%;font-size:1em;background-color:#24CCCA" >&nbsp;</th>
				<th style="width:10%;font-size:1em;background-color:#24CCCA" >&nbsp;</th>
			...
			?>
				<tr id="data">
				    ...
				    <td style="width:10%;font-size:1vw" > <?php echo $rows['CITY']; ?> </td>
				    <td style="width:10%;font-size:1vw" > <?php echo $rows['COUNTRY_ID']; ?> </td>
				    <td style="width:10%;font-size:1vw" > <?php echo $rows['LAST_UPDATE']; ?> </td>
				    <td style="width:100%;font-size:1vw" class="w3-dropdown-click">
				        <a href="updatecityrow.php?cityid=<?php echo $rows['CITY_ID']; ?>" style=text-decoration:none> 
				    ...
				    <button type="button" style="width:100%" onclick="myFunction()" class="w3-button w3-red">
				        <?php echo "<a style= text-decoration:none href=delete1.php?id4=".$rows['CITY_ID'].">"?>
